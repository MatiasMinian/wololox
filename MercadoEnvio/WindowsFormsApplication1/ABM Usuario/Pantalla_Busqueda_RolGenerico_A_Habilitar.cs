...
{
    public partial class Pantalla_Busqueda_RolGenerico_A_Habilitar : Form
    {
        ...
        public Pantalla_Busqueda_RolGenerico_A_Habilitar(decimal id)
        {
            InitializeComponent();
            this.idRol = id;
        }
        ...
        private void dataClientes_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (senderGrid.Columns[e.ColumnIndex] is DataGridViewButtonColumn &&
                e.RowIndex >= 0)
            {
                userAdapter.HabilitarUsuario(Convert.ToDecimal(Convert.ToDecimal(dataUsuarios.Rows[e.RowIndex].Cells[0].Value)));
