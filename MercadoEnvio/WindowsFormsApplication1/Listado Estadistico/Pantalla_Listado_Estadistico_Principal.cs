...
namespace WindowsFormsApplication1.Listado_Estadistico
{
    public partial class Pantalla_Listado_Estadistico_Principal : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            pantalla1.guardaParametrosParaBusqueda(this.numericUpDown1.Value, this.numericUpDown2.Value);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            pantalla2.guardaParametrosParaBusqueda(this.numericUpDown1.Value, this.numericUpDown2.Value);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            pantalla3.guardaParametrosParaBusqueda(this.numericUpDown1.Value, this.numericUpDown2.Value);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            pantalla4.guardaParametrosParaBusqueda(this.numericUpDown1.Value, this.numericUpDown2.Value);
