...
insert into WOLOLOX.funcionalidades(nombre) values('ABM rubros')
...
insert into WOLOLOX.funcionalidades(nombre) values('Genarar publicacion')
...
insert into @funcionalidades_empresa values('Consulta facturas')
